...
import org.dhis2.dii.ViewModelModule;
...
@Singleton
@Component(modules = {
        ViewModelModule.class, AppModule.class, DbModule.class, SchedulerModule.class, UtilsModule.class, MetadataModule.class, QRModule.class
})
