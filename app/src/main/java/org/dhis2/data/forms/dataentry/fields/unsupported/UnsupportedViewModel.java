...
public abstract class UnsupportedViewModel extends FieldViewModel {
    ...
    public static FieldViewModel create(String id, String label, Boolean mandatory, String value, String section, Boolean editable,
        ...
        return new AutoValue_UnsupportedViewModel(id, label, false, value, section, null, editable,
                null, null, null, description, objectStyle);
    }

    @Override
    public FieldViewModel setMandatory() {
        return new AutoValue_UnsupportedViewModel(uid(), label(), false, value(), programStageSection(),
    ...
    public FieldViewModel withValue(String data) {
        return new AutoValue_UnsupportedViewModel(uid(), label(), false, data, programStageSection(),
