...
public class RelationshipSpinnerAdapter extends ArrayAdapter<Pair<RelationshipType, String>> {
    ...
    public RelationshipSpinnerAdapter(@NonNull Context context, @NonNull List<RelationshipType> itemList) {
        super(context, android.R.layout.simple_spinner_dropdown_item);
        this.data = new ArrayList<>();
        this.data.add(Pair.create(RelationshipType.builder().build(), context.getString(R.string.add_relation_button)));
        for (RelationshipType relationshipTypeModel : itemList) {
