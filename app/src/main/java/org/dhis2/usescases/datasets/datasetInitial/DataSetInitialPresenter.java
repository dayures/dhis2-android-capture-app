...
public class DataSetInitialPresenter implements DataSetInitialContract.DataSetDetailPresenter {

    private CompositeDisposable compositeDisposable;
    private DataSetInitialRepository dataSetInitialRepository;
    private DataSetInitialContract.DataSetDetailView view;
    ...
    @Override
    public void init(DataSetInitialContract.DataSetDetailView view) {
        this.view = view;
